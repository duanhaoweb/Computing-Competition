...
namespace QuickOutline.Scripts
{
  ...
  public class Outline : MonoBehaviour {
    ...
    [SerializeField]
    private Color outlineSubColor = Color.clear;
    ...
    void UpdateMaterialProperties() {
      ...
      this.outlineFillMaterial.SetColor(OutlineColor1, this.outlineColor);
      this.outlineFillMaterial.SetColor(SubColor, this.outlineSubColor == Color.clear ? this.outlineColor : this.outlineSubColor);
